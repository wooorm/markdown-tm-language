  ...
  "repository": {
      ...
      "patterns": [
        {
          ...
          "captures": {
            "1": {
              "name": "punctuation.definition.string.begin.autolink.md"
            },
            "2": {
              "name": "string.other.link.autolink.email.md"
            },
            "3": {
              "name": "punctuation.definition.string.end.autolink.md"
            }
          }
        },
        {
    ...
    "commonmark-attention": {
      "patterns": [
        {
          "match": "(?<=\\S)\\*{3,}|\\*{3,}(?=\\S)",
          "name": "punctuation.definition.string.strong.emphasis.asterisk.md"
        },
        {
          "match": "(?<=[\\p{L}\\p{N}])_{3,}(?![\\p{L}\\p{N}])|(?<=\\p{P})_{3,}|(?<![\\p{L}\\p{N}]|\\p{P})_{3,}(?!\\s)",
          "name": "punctuation.definition.string.strong.emphasis.underscore.md"
        },
        {
          "match": "(?<=\\S)\\*{2}|\\*{2}(?=\\S)",
          "name": "punctuation.definition.string.strong.asterisk.md"
        },
        {
          "match": "(?<=[\\p{L}\\p{N}])_{2}(?![\\p{L}\\p{N}])|(?<=\\p{P})_{2}|(?<![\\p{L}\\p{N}]|\\p{P})_{2}(?!\\s)",
          "name": "punctuation.definition.string.strong.underscore.md"
        },
        {
          "match": "(?<=\\S)\\*|\\*(?=\\S)",
          "name": "punctuation.definition.string.emphasis.asterisk.md"
        },
        {
          "match": "(?<=[\\p{L}\\p{N}])_(?![\\p{L}\\p{N}])|(?<=\\p{P})_|(?<![\\p{L}\\p{N}]|\\p{P})_(?!\\s)",
          "name": "punctuation.definition.string.emphasis.underscore.md"
        }
      ]
    },
    ...
    "commonmark-character-escape": {
      "match": "\\\\(?:[!\"#$%&'()*+,\\-.\\/:;<=>?@\\[\\\\\\]^_`{|}~])",
      "name": "support.constant.character.escape.md"
    },
    ...
    "commonmark-code-text": {
      ...
      "captures": {
        "1": {
          "name": "punctuation.definition.string.begin.code.md"
        },
        "2": {
          "name": "markup.raw.code.text.md"
        },
        "3": {
          "name": "punctuation.definition.string.end.code.md"
        }
      }
    },
    "commonmark-definition": {
      ...
      "captures": {
        "1": {
          "name": "punctuation.definition.string.start.md"
        },
        "2": {
        ...
        "3": {
          "name": "punctuation.definition.string.end.md"
        },
        "4": {
          "name": "punctuation.separator.key-value.md"
        },
        "5": {
          "name": "punctuation.definition.string.begin.destination.md"
        },
        "6": {
        ...
        "7": {
          "name": "punctuation.definition.string.end.destination.md"
        },
        "8": {
          "name": "string.other.link.destination.md",
          "patterns": [
        ...
        "9": {
          "name": "punctuation.definition.string.begin.md"
        },
        "10": {
    ...
    "commonmark-hard-break-escape": {
      "match": "\\\\$",
      "name": "support.constant.character.escape.line-ending.md"
    },
    "commonmark-hard-break-trailing": {
      "match": "( ){2,}$",
      "name": "carriage-return support.constant.character.escape.line-ending.md"
    },
    ...
    "commonmark-label-start": {
      "patterns": [
        {
          "match": "\\!\\[(?!\\^)",
          "name": "punctuation.definition.string.begin.image.md"
        },
        {
          "match": "\\[",
          "name": "punctuation.definition.string.begin.link.md"
        }
      ]
    },
    ...
    "extension-directive-text": {
      ...
      "captures": {
        "1": {
          "name": "punctuation.definition.string.begin.directive.md"
        },
        "2": {
          "name": "entity.name.function.md"
        },
        "3": {
          "name": "punctuation.definition.string.begin.directive.label.md"
        },
        "4": {
          "patterns": [
            {
        ...
        "5": {
          "name": "punctuation.definition.string.end.directive.label.md"
        },
        "6": {
          "name": "punctuation.definition.string.begin.directive.attributes.md"
        },
        "7": {
          "patterns": [
            {
        ...
        "8": {
          "name": "punctuation.definition.string.end.directive.attributes.md"
        }
      }
    },
    ...
    "extension-directive-container": {
      ...
      "endCaptures": {
        "1": {
          "name": "punctuation.definition.string.end.directive.md"
        }
      }
    },
    ...
    "extension-gfm-footnote-call": {
      ...
      "captures": {
        ...
        "2": {
          "name": "punctuation.definition.string.begin.footnote.md"
        },
        "3": {
          "name": "entity.name.identifier.md",
          "patterns": [
        ...
        "4": {
          "name": "punctuation.definition.string.end.footnote.md"
        }
      }
    },
      ...
      "patterns": [
        {
          ...
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.math.flow.md"
            },
            "2": {
              "name": "entity.name.function.md"
            }
          ...
          "endCaptures": {
            "1": {
              "name": "punctuation.definition.string.end.math.flow.md"
            }
          },
          "name": "markup.code.other.md"
        }
    ...
    "extension-math-text": {
      ...
      "captures": {
        "1": {
          "name": "punctuation.definition.string.begin.math.md"
        },
        "2": {
          "name": "markup.raw.math.md"
        },
        "3": {
          "name": "punctuation.definition.string.end.math.md"
        }
      }
    },
    "extension-toml": {
    ...
    "whatwg-html-attribute-event-handler": {
      ...
      "captures": {
        ...
        "3": {
          "name": "punctuation.definition.string.begin.html.md"
        },
        "4": {
    ...
    "commonmark-code-fenced-c": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:dtrace|dtrace\\x2dscript|oncrpc|rpc|rpcgen|unified\\x2dparallel\\x2dc|x\\x2dbitmap|x\\x2dpixmap|xdr|\\.?(?:c|cats|cl|d|h|idc|opencl|pm|upc|x|xbm|xpm|xs)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-c++": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:ags|ags\\x2dscript|asymptote|c\\+\\+|edje\\x2ddata\\x2dcollection|game\\x2dmaker\\x2dlanguage|swig|\\.?(?:asc|ash|asy|c\\+\\+|cc|cp|cpp|cppm|cxx|edc|gml|h|h\\+\\+|hh|hpp|hxx|i|inc|inl|ino|ipp|ixx|metal|re|tcc|tpp)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-md": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:pandoc|rmarkdown|\\.?(?:livemd|markdown|md|mdown|mdwn|mkd|mkdn|mkdown|qmd|rmd|ronn|scd|workbook)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-ini": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:altium|altium\\x2ddesigner|dosini|\\.?(?:cfg|cnf|dof|ini|lektorproject|outjob|pcbdoc|prefs|prjpcb|pro|properties|schdoc|url)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-java": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:apex|chuck|unrealscript|\\.?(?:ck|cls|jav|java|jsh|uc)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-makefile": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:bsdmake|mf|\\.?(?:d|mak|make|makefile|mk|mkfile)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-objc": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:obj\\x2dc|objc|objective\\x2dc|objectivec|\\.?(?:h|m)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-perl": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:cperl|\\.?(?:al|cgi|fcgi|perl|ph|pl|plx|pm|psgi|t)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-python": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:bazel|easybuild|python|python3|rusthon|snakemake|starlark|xonsh|\\.?(?:bzl|cgi|eb|fcgi|gyp|gypi|lmi|py|py3|pyde|pyi|pyp|pyt|pyw|rpy|sage|sagews|smk|snakefile|spec|star|tac|wsgi|xpy|xsh)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-ruby": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:jruby|macruby|\\.?(?:builder|druby|duby|eye|fcgi|gemspec|god|jbuilder|mirah|mspec|pluginspec|podspec|prawn|rabl|rake|rb|rbi|rbuild|rbw|rbx|ru|ruby|spec|thor|watchr)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-shell": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:abuild|alpine\\x2dabuild|apkbuild|gentoo\\x2debuild|gentoo\\x2declass|openrc|openrc\\x2drunscript|shell|shell\\x2dscript|\\.?(?:bash|bats|cgi|command|csh|ebuild|eclass|fcgi|ksh|sh|sh\\.in|tcsh|tmux|tool|zsh|zsh\\x2dtheme)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-sql": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:plpgsql|sqlpl|\\.?(?:cql|db2|ddl|inc|mysql|pgsql|prc|sql|sql|sql|tab|udf|viw)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-yaml": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:jar\\x2dmanifest|kaitai\\x2dstruct|oasv2\\x2dyaml|oasv3\\x2dyaml|unity3d\\x2dasset|\\.?(?:anim|asset|ksy|lookml|mask|mat|meta|mir|model\\.lkml|prefab|raml|reek|rviz|sublime\\x2dsyntax|syntax|unity|view\\.lkml|yaml|yaml|yaml|yaml\\x2dtmlanguage|yaml\\.sed|yml|yml|yml|yml\\.mysql)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-basic": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:\\.?(?:hta|htm|html|html\\.hl|inc|kit|mtml|xht|xhtml)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-php": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:html\\+php|\\.?(?:aw|ctp|fcgi|inc|php|php3|php4|php5|phps|phpt|phtml)))(?:[\\t ]+(?:[^\\n\\r`])+)?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "punctuation.definition.string.begin.code.fenced.md"
            },
