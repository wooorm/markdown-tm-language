...
const grammar = {
  ...
  "repository": {
    ...
    "commonmark-code-fenced-cs": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:beef|c#|cakescript|csharp|(?:.*\\.)?(?:bf|cake|cs|cs\\.pp|csx|eq|linq|uno)))(?:[\\t ]+((?:[^\\n\\r`])+))?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-haskell": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:c2hs|c2hs\\x2dhaskell|frege|haskell|(?:.*\\.)?(?:chs|dhall|hs|hs\\x2dboot|hsc)))(?:[\\t ]+((?:[^\\n\\r`])+))?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-shell": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:abuild|alpine\\x2dabuild|apkbuild|envrc|gentoo\\x2debuild|gentoo\\x2declass|openrc|openrc\\x2drunscript|shell|shell\\x2dscript|(?:.*\\.)?(?:bash|bats|command|csh|ebuild|eclass|ksh|sh|sh\\.in|tcsh|tmux|tool|zsh|zsh\\x2dtheme)))(?:[\\t ]+((?:[^\\n\\r`])+))?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.md"
            },
    ...
    "commonmark-code-fenced-vbnet": {
      "patterns": [
        {
          "begin": "(?:^|\\G)[ ]{0,3}(`{3,})(?:[\\t ]*((?i:fb|freebasic|realbasic|vb\\x2d\\.net|vb\\.net|vbnet|vbscript|visual\\x2dbasic|visual\\x2dbasic\\x2d\\.net|(?:.*\\.)?(?:bi|rbbas|rbfrm|rbmnu|rbres|rbtbar|rbuistate|vb|vbhtml|vbs)))(?:[\\t ]+((?:[^\\n\\r`])+))?)(?:[\\t ]*$)",
          "beginCaptures": {
            "1": {
              "name": "string.other.begin.code.fenced.md"
            },
